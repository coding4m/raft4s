...
object ProjectSettings {
  ...
  lazy val commonSettings: Seq[Setting[_]] =
    rootSettings ++ formatterSettings ++ Seq(
      resolvers += "DDDLib Releases Group" at "http://nexus.dddlib.org/content/groups/public-releases",
      resolvers += "DDDLib Snapshots Group" at "http://nexus.dddlib.org/content/groups/public-snapshots"
    )
  ...
  lazy val headerSettings: Seq[Setting[_]] = {
    val header = Apache2_0("2016 - 2017", "Forever High Technology <http://www.foreverht.com> - all rights reserved.")
  ...
  lazy val documentationSettings: Seq[Setting[_]] =
    unidocSettings ++
      ...
      ghpages.settings ++
      Seq(
        git.remoteRepo := "git@git.oschina.net:workplus/rxtalk-library.git",
